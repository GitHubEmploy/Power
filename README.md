<h3 align = "center">
    <img src = "https://cdn.discordapp.com/attachments/729758326635888703/790811463018872832/8a422d537c5359041524fcc32e9aff92.jpg" alt = "Logo" />
</h3>
...
Power is a simple and and minimalistic server monitoring tool. Power supports adaptive design system. Also it supports dark theme.
...
Power works nice on all popular operating systems, because it uses [OSHI](https://github.com/oshi/oshi).
...
Run the start.sh file after installing all dependencies such as java and mvn
...
<br>
    ...
    1. Clone the project
    2. docker build --tag Power
    3. docker run --rm -it --name Power -p 4000:4000 -p <application port>:<application port> --privileged Power
